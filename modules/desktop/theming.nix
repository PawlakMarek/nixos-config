...
in {
  ...
  config = mkIf cfg.enable {
    ...
    environment = {
      ...
      # XFCE-specific theming and dconf configuration
      etc = {
        ...
        "dconf/db/local.d/01-theme".text = ''
        ...
        "dconf/db/local.d/locks/theme".text = ''
    ...
    # Program theming configuration
    programs = {
      firefox = mkIf cfg.applications.firefox {
        enable = true;
      ...
      thunderbird = mkIf cfg.applications.thunderbird {
        enable = true;
